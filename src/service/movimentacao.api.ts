import { BaseCreate, BaseFindById, BaseFindPage, BaseRemove, BaseUpdate } from "@/service/base.api";
...
export const useUpdateMovimentacaoApi = () => new BaseUpdate<Movimentacao, number>(API_URL);
